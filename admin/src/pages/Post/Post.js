...
import { getPostFormAction, getProductFormAction } from '../../redux/actions/DrawerActions/DrawerActions';
...
export default function Product() {
    ...
    return (
        <>
            ...
            <hr />
            <Table columns={PostColumns} dataSource={PostList} onChange={onChange} />
        </>
    )
}
